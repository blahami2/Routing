...
/**
 * An implementation of {@link GraphEntityFactory} creating {@link JgraphtGraph}-related objects.
 *
...
public class JgraphtGraphEntityFactory implements GraphEntityFactory {
    ...
    public Graph createGraph() {
        return new JgraphtGraph( new Multigraph<>( new EdgeFactory<Node, Edge>() {
            @Override
