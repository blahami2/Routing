...
import cz.certicon.routing.application.algorithms.ContractionHierarchiesRoutingAlgorithm;
...
import cz.certicon.routing.application.common.SimpleRouteBuilder;
import cz.certicon.routing.model.entity.DistanceType;
import cz.certicon.routing.model.entity.Graph;
import cz.certicon.routing.model.entity.ch.PreprocessedData;
import cz.certicon.routing.model.entity.ch.SimpleChDataBuilder;
...
public class ContractionHierarchiesRoutingAlgorithmTest {
    ...
    public void testRoute() throws RouteNotFoundException {
        ...
        nodeSetBuilder = fct.createNodeSetBuilder();
        nodeSetBuilder.addCrossroad( NodeSet.NodeCategory.SOURCE, 3 );
        nodeSetBuilder.addCrossroad( NodeSet.NodeCategory.TARGET, 5 );
        ...
        result = instance.route( routeBuilder, nodeSetBuilder.build() );
